...
Master Runtime's logging capabilities to quickly diagnose issues in your deployments.
...
<AccordionGroup>
  ...
  <Accordion title="Don't log secrets">
    Never log API keys, passwords, or PII. Runtime redacts known secrets, but be careful.
  </Accordion>
</AccordionGroup>

## Related

- [`runtm logs`](/open-source/cli/logs) - CLI reference
- [Logs API](/open-source/api/logs) - API reference
