...
<CardGroup cols={2}>
  <Card title="Requirements" icon="list-check" href="/open-source/self-hosting/requirements">
    Detailed system requirements
  </Card>
  <Card title="Docker Compose" icon="docker" href="/open-source/self-hosting/docker-compose">
