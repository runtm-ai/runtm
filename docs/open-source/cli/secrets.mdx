...
See [Secrets & Environment Variables](/open-source/features/secrets) for more details.

---

## Related commands

- [`runtm deploy`](/open-source/cli/deploy) - Deploy with secrets
- [`runtm validate`](/open-source/cli/validate) - Validate secret configuration
