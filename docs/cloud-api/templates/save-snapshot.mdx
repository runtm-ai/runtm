...
<RequestExample>
```bash cURL
curl -X POST "https://app.runtm.com/api/cloud/org-templates/tmpl_abc123/save-snapshot" \
...
response = requests.post(
    "https://app.runtm.com/api/cloud/org-templates/tmpl_abc123/save-snapshot",
    headers={
