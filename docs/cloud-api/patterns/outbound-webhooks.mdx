...
description: "The two outbound webhook events Runtime emits (prompt.completed, prompt.timed_out), their payload, delivery guarantees, and a minimal receiver. Read when wiring Runtime into an external system; for inbound triggers see Build > Triggers."
---
