...
This is the *time*-driven automation primitive. For *event*-driven agents (a Slack mention, a GitHub issue), see [Slack](/cloud-api/integrations/slack/integration-get) and [GitHub](/cloud-api/integrations/github-app/installations-list) integrations.
