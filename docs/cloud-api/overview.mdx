...
<CardGroup cols={2}>
  ...
  <Card title="Context" icon="brain" href="/cloud-api/context/user-instructions-get">
    System instructions, skills, MCP servers, docs, and knowledge sources that shape agent behavior.
  </Card>
  <Card title="Guardrails" icon="shield" href="/cloud-api/guardrails/allowlist-policy-get">
  ...
  <Card title="Provider Keys" icon="key-skeleton" href="/cloud-api/provider-keys/resolved">
