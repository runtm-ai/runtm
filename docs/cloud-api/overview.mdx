...
For self-hosted instances, substitute your own host. Endpoint paths shown in this documentation always start with `/api/...`, `/api/v1/...`, `/api/v2/...`, or `/auth/...` - append them to the host above.
