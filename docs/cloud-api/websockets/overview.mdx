...
<Steps>
  <Step title="Request a token">
    ...
    ```bash
    curl -X POST "https://app.runtm.com/api/cloud/sessions/ses_abc123/ws-token" \
  ...
  <Step title="Connect via WebSocket">
    ...
    ```
    wss://app.runtm.com/api/cloud/sessions/ses_abc123/terminal?token=eyJhbGciOiJIUzI1NiIs...
    ```
  </Step>
