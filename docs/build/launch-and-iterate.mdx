...
<Frame caption="Activity → Agents is the scorecard: graded runs, hit rate, value returned and budget per agent.">
  <img src="/images/build/activity-agents-scorecard.png" alt="Activity page, Agents tab, showing per-agent scorecard rows" />
</Frame>

<Frame caption="Run now on a scheduled agent executes the same path as a cron tick, so validate before you enable.">
  <img src="/images/build/scheduled-agents-new.png" alt="Scheduled agents tab with a new schedule dialog open" />
</Frame>
