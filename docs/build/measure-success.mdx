...
<Steps>
  <Step title="Open the agent's Performance evaluation section">
    ...
    <Frame caption="Performance evaluation: monthly budget, then one card per category.">
      <img src="/images/dashboard/agent-evaluation.png" alt="Performance evaluation section with the monthly budget field and an evaluation category card" />
    </Frame>
  </Step>
...
<Frame caption="Activity > Agents: the scorecard for every roster agent over the selected window.">
  <img src="/images/dashboard/activity-agents-scorecard.png" alt="Activity page, Agents tab showing per-agent graded runs, hit rate, spend and value" />
</Frame>
