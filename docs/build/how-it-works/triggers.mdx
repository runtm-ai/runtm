...
<Frame caption="The New Agent dialog ends on the Triggers step. Connect one now or add more later from the agent's settings.">
  <img src="/images/build/new-agent-triggers.png" alt="New Agent dialog, Triggers step, listing Slack, Linear, GitHub, Email, WhatsApp, SMS and Voice rows" />
</Frame>
...
<Frame caption="The Integrations page groups live triggers. Cards with a Talk to the Team button are not implemented.">
  <img src="/images/build/integrations-triggers.png" alt="Integrations page, Agent Triggers section, showing Slack, Linear, GitHub Apps, Email, WhatsApp and SMS" />
</Frame>
...
<Frame caption="A scheduled agent is a prompt, a cron expression in UTC, a template, and at most one post target.">
  <img src="/images/build/scheduled-agents-new.png" alt="New scheduled agent dialog with prompt, run-as mode, schedule popover and post target" />
</Frame>
