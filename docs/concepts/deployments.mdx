---
title: Deployments
description: "How a session ships to a live URL: the scaffold, validate, preflight and run pipeline, project types, the runtm.yaml manifest, build logs and volumes. Read when an agent must deploy the app it produced."
---
