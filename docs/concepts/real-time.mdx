---
title: Real-time
description: "The three WebSocket channels (terminal, prompt streaming, collaboration), the token exchange, frame formats, and when to use REST instead. Read when building a live UI or streaming a run."
---
