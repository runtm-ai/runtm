---
title: Templates
description: "What a template is (the environment and capability container an agent runs on), what gets baked into its snapshot, builds and rebuilds, snapshots from sessions, secrets and permissions. Read when a session boots without what you attached."
---
