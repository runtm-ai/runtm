...
<Steps>
  ...
  <Step title="Define and connect Postgres read-only">
    ...
    cli-handoff: https://app.runtm.com/connect?provider=postgres&scope=org&method=connection
    cli-verify: runtm-api tools list --provider postgres --scope org
    ```
  ...
  <Step title="Connect Notion from the catalog">
    ...
    ```text
    cli-handoff: https://app.runtm.com/connect?provider=notion&scope=org&method=static
    cli-verify: runtm-api tools list --provider notion --scope org
    ```
